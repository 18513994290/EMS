				...
				<dl class="clear" style="width:270px;" data-spy="affix" data-offset-top="235" id="questionindex">
					...
					<div class="tab-content" style="margin-top:5px;" id="questionindex">
						...
						<div role="tabpanel" class="tab-pane tableindex{x2;if:v:qid == 1} active{x2;endif}" id="qt_{x2;v:quest}">
						   ...
						   <a id="sign_{x2;v:question['questionid']}" href="javascript:;" onclick="javascript:gotoquestion('{x2;v:question['questionid']}')" class="btn btn-block btn-default{x2;if:$sessionvars['examsessionsign'][v:question['questionid']]} btn-danger{x2;endif}"><span>	{x2;v:question['questionknowsid'][0]['knows']}</span><span></span></a>
							{x2;endtree}
