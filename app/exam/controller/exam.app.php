...
class action extends app
{
	...
	private function paper()
	{
		...
		$lefttime = 0;
		$questype = $this->basic->getQuestypeList();
        $aknows = $this->section->getKnowsListByArgs(array(array("AND","knowssectionid = :knowssectionid",'knowssectionid',1),array("AND","knowsstatus = 1")));
		...
		{
//            echo "<pre>";
//            print_r($sessionvars['examsessionquestion']['questions']);
           // print_r($sessionvars['examsessionquestion']['questions'][1]['6821']);
//            print_r($sessionvars['examsessionquestion']['questions'][1]['6821']['questionknowsid'][0]['knows']);
