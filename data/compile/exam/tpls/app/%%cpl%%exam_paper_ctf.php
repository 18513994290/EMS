...
<div class="container-fluid" id="questioncontent">
 ...
 $qnid++; ?>
						   ...
						   <a id="sign_<?php echo $question['questionid']; ?>" href="javascript:;" onclick="javascript:gotoquestion('<?php echo $question['questionid']; ?>')" class="btn btn-block btn-default<?php if($this->tpl_var['sessionvars']['examsessionsign'][$question['questionid']]){ ?> btn-danger<?php } ?>"><span>	<?php echo $question['questionknowsid'][0]['knows']; ?></span><span></span></a>
							<?php } ?>
							<?php $qrid = 0;
