...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-basic">竞赛管理</a></li>
							<li class="active">添加竞赛场次</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-basic-add" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label for="basic" class="control-label col-sm-2">竞赛名称</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">竞赛状态</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="basicthumb" class="control-label col-sm-2">竞赛缩略图</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="basicsubjectid" class="control-label col-sm-2">竞赛科目</label>
							<div class="col-sm-4">
 ...
 $aid++; ?>
							...
							<input name="args[basicdemo]"  value="1" type="hidden"/>
							<input name="args[basicareaid]"  value="1" type="hidden"/>
						...
						<div class="form-group">
							<label for="basicprice" class="control-label col-sm-2">竞赛简介</label>
							<div class="col-sm-9">
